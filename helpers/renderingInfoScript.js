  ...
  function constructPictureElement(imageSliderRootElement, sliderImageElements, multiple) {
    ...
    window.q_domready.then(function() {
      ...
      sliderImageElements.forEach(function(sliderImage) {
        ...
        var innerHTMLPictureElement = '${elementMarkup}'.replace(/png1x/g, urls.png1x).replace(/png2x/g, 2 * urls.png2x).replace(/webp1x/g, urls.webp1x).replace(/webp2x/g, urls.webp2x).replace(/index/g, imageIndex);
